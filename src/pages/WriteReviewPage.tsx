    ...
    <div className="min-h-screen bg-surface-secondary dark:bg-gray-950">
      ...
      {submitted ? (
        <FadeIn className="flex flex-col items-center justify-center px-8 pt-20">
          ...
          <h2 className="text-xl font-black text-text-primary dark:text-white">Thank You!</h2>
          <p className="text-sm text-text-secondary dark:text-gray-400 text-center mt-2">
        ...
        <div className="p-4 space-y-6">
          <FadeIn delay={0.1}>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-4">
              <h3 className="text-sm font-bold text-text-primary dark:text-white mb-3">How was the food?</h3>
              ...
              <p className="text-xs text-text-tertiary dark:text-gray-500 text-center mt-2">
          ...
          <FadeIn delay={0.2}>
            {/* Delivery rating */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-4">
              <h3 className="text-sm font-bold text-text-primary dark:text-white mb-3">How was the delivery?</h3>
              <div className="flex justify-center">
                <RatingStars
          ...
          <FadeIn delay={0.3}>
            {/* Comment */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-4">
              <h3 className="text-sm font-bold text-text-primary dark:text-white mb-3">Tell us more (optional)</h3>
              <textarea
                value={comment}
                onChange={(e) => setComment(e.target.value)}
                placeholder="What did you enjoy? What could be better?"
                className="w-full h-28 rounded-xl bg-surface-secondary dark:bg-gray-800 px-4 py-3 text-sm text-text-primary dark:text-white placeholder:text-text-tertiary resize-none focus:outline-none focus:ring-2 focus:ring-primary/30"
              />
              <p className="text-xs text-text-tertiary mt-1 text-right">{comment.length}/500</p>
            </div>
          </FadeIn>

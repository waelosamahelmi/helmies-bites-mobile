  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pt-8">
        ...
        <h1 className="text-2xl font-black text-text-primary text-center">Welcome back</h1>
        <p className="text-sm text-text-secondary text-center mt-1">Sign in to your Helmies Bites account</p>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center"><span className="bg-white px-4 text-xs text-text-tertiary">or</span></div>
        </div>

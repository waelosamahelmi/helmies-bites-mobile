        ...
        <>
          ...
          >
            ...
            <div className="px-4 py-4 space-y-6">
              {/* Dietary */}
              <div>
                <h3 className="text-sm font-bold text-white mb-3">Dietary</h3>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-bold text-white">Max delivery time</h3>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-bold text-white">Min rating</h3>
                </div>
                <div className="flex gap-2">
              ...
              >
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <span className="text-sm font-bold text-white">Free delivery only</span>
                </div>
                <div className={`w-12 h-7 rounded-full transition-colors relative ${
                  local.freeDelivery ? 'bg-primary' : 'bg-border-strong'
                }`}>
                  <motion.div
                    animate={{ x: local.freeDelivery ? 20 : 2 }}
                    transition={{ type: 'spring', damping: 20 }}
                    className="absolute top-[3px] w-[22px] h-[22px] rounded-full glass-card shadow-sm"
                  />
                </div>
              </button>
            </div>

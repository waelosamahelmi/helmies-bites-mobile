  ...
  return (
    <div className="px-4 pb-2">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-sm font-bold text-white">Order again</h3>
      </div>
      <div className="space-y-2">
        {recentOrders.map((order, i) => (
          <motion.button
            ...
            className="w-full glass-card rounded-xl p-3 flex items-center gap-3 shadow-glass hover:shadow-glass-hover transition-shadow"
          >
